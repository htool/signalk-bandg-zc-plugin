...
var createPGN = tsPgns.createPGN
var getPGNWithId = tsPgns.getPGNWithId
var getEnumeration = tsPgns.getEnumeration

var KEY_DEF = getPGNWithId('simnetZcKey')
var KNOB_DEF = getPGNWithId('simnetZcKnob')
if (!KEY_DEF || !KNOB_DEF || !createPGN('simnetZcKey', {})) {
  throw new Error(
    'ts-pgns is missing canboat-derived simnetZcKey/simnetZcKnob (stock npm 1.11.18 does not have them)'
  )
}
